...
winsocket = 'ws2_32.dll';      { 16 bits TCP/IP system DLL }
winsocket2 = 'ws2_32.dll';       { 32 bits TCP/IP system DLL version 2}
{$ENDIF}
...
{$ENDIF}
  ...
  protected
    ...
    FBufferedByteCount  : LongInt;   { V5.20 how man xmit bytes unsent, don't close until 0 }
    ...
    while bMore do begin
        ...
        if Len <= 0 then begin
            ...
            if Count>0 then begin
                ...
                if FBufferedByteCount<0 then FBufferedByteCount:=0;  
            end;
            if Count = 0 then
