...
function ParseAppender(AProps : TProperties; AName : String) : TAppender;
var
   appender : TAppender;
   layout : TLayout;
   index : Integer;
   ...
   layoutPrefix : String;
begin
   index := registry.IndexOf(AName);
   if (index >= 0) then begin
      result := TAppender(registry.Objects[index]);
      exit;
   end;
   ...
   registry.AddObject(AName, appender);
   result := appender;
end;
